...
`event` platforms listed above. CI is green — hassfest validation, HACS
validation, and the test suite (105 tests) all pass — but **none of these
new entities have been verified against real hardware yet.** That
